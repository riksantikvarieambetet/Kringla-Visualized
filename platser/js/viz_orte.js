...
function generateOverlay () {
    ...
    var infos = 
        [
            { x: 355, y: 235, text: "Cirkelstorleken definieras av antalet poster", r: 30},
            { x: 150, y: 360, text: "Varje båges storlek bestäms av antalet poster av respektive post typ", r: 25},
            { x: 950, y: 520, text: "När du för musen över en cirkelbåge visas namnet och antalet poster för post typen.", r: 30},
            { x: 55, y: 140, text: "sorteras alfabetiskt och efter frekvens", r: 20}
        ];
