...
def get_province_time_counts_url(province):
    return 'http://www.kulturarvsdata.se/ksamsok/api?method=statisticSearch&index=fromTime=*&query=provinceName={0}&removeBelow=1&x-api={1}'.format(province, user_input)
